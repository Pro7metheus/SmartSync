...
public final class FragmentRecipeListBinding implements ViewBinding {
  ...
  private FragmentRecipeListBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout layoutEmpty, @NonNull RecyclerView rvRecipes) {
  ...
  public static FragmentRecipeListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRecipeListBinding((LinearLayout) rootView, layoutEmpty, rvRecipes);
    }
